    ...
    */
    ...
    'connections' => [
        ...
        'mysql2' => [
            ...
            'database' => env('DB_IMPORT_DATABASE', 'forge'),
            'username' => env('DB_IMPORT_USERNAME', 'forge'),
        ...
        'mysql3' => [
            ...
            'port' => env('DB_ORIGINAL_PORT', '3306'),
            'database' => env('DB_ORIGINAL_DATABASE', 'forge'),
            'username' => env('DB_ORIGINAL_USERNAME', 'forge'),
            'password' => env('DB_ORIGINAL_PASSWORD', ''),
            'unix_socket' => env('DB_ORIGINAL_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
